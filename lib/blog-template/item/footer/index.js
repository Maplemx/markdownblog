...
function createFooter (pageFrame, data) {
    ...
    return `
        ...
        <div class = "mdb-footer">
            THIS BLOG BELONGS TO <a href = "mailto:${ setting.blogOwnerEmail }">${ setting.blogOwner }</a>　POWERED BY <a href = "mailto:${ setting.markdownBlogAuthorEmail }">Markdown Blog ${ setting.markdownBlogVersion }</a>
        </div>
        <!-- Markdown Blog Footer -->
    `;
}
